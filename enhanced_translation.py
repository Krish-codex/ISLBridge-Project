...
Supports multiple languages with Google Translate integration
"""
import pyttsx3
from typing import Optional, Dict, List, Tuple
import logging

# Try to import Google Translate (optional dependency)
try:
...
# Import translation config with fallback
try:
...
class MultiLanguageTranslator:
    ...
    def __init__(self):
        ...
        # Enhanced ISL gesture dictionary with multiple languages
        self.gesture_dictionary = {
            # Complete alphabet - show just the letter/number
            ...
            # Numbers 0-9 - show just the number
    ...
    def setup_tts(self) -> None:
        ...
        try:
            ...
            # Get available voices and try to set language-appropriate voice
    ...
    def translate_gesture(self, gesture: str, target_language: Optional[str] = None) -> str:
        ...
        # Fallback to Google Translate for complex sentences
        if self.google_translator and len(gesture.split()) > 1:
            try:
                # Assume source is English for sentences
        ...
        # Final fallback - return original gesture
        return gesture
    ...
    def translate_sentence(self, sentence: str, target_language: Optional[str] = None) -> str:
        ...
        # If sentence is just individual letters/numbers, translate each
        ...
        # For phrases and sentences, use Google Translate
    ...
    def speak_text(self, text: str, language: Optional[str] = None) -> bool:
        ...
        try:
            ...
            # For letters and numbers, convert to spoken form for TTS
            if len(text) == 1 and text.isalnum():
                # Create spoken versions for TTS
                spoken_map = {
                    # Letters - spoken form
                ...
                # For words and sentences, translate normally
